...
namespace FreeImageAPI
{
	...
	public static partial class FreeImage
	{
		...
		public static System.Drawing.Bitmap GetBitmap(FIBITMAP dib)
		{
		...
		/// <exception cref="ArgumentException">
		/// The image type of <paramref name="dib"/> is not FIT_BITMAP.</exception>
		internal static System.Drawing.Bitmap GetBitmap(FIBITMAP dib, bool copyMetadata)
		{
			if (dib.IsNull)
			{
			...
			System.Drawing.Bitmap result = new System.Drawing.Bitmap(width, height, format);
			BitmapData data;
		...
		public static FIBITMAP CreateFromBitmap(System.Drawing.Bitmap bitmap)
		{
		...
		/// <exception cref="ArgumentException">
		/// The bitmaps pixelformat is invalid.</exception>
		internal static FIBITMAP CreateFromBitmap(System.Drawing.Bitmap bitmap, bool copyMetadata)
		{
			if (bitmap == null)
			{
		...
		/// <exception cref="ArgumentException">
		/// The bitmaps pixelformat is invalid.</exception>
		public static bool SaveBitmap(System.Drawing.Bitmap bitmap, string filename)
		{
			return SaveBitmap(
				bitmap,
				filename,
		...
		/// <exception cref="ArgumentException">
		/// The bitmaps pixelformat is invalid.</exception>
		public static bool SaveBitmap(System.Drawing.Bitmap bitmap, string filename, FREE_IMAGE_SAVE_FLAGS flags)
		{
			return SaveBitmap(
				bitmap,
				filename,
		...
		public static System.Drawing.Bitmap LoadBitmap(string filename, FREE_IMAGE_LOAD_FLAGS flags, ref FREE_IMAGE_FORMAT format)
		{
			FIBITMAP dib = LoadEx(filename, flags, ref format);
			System.Drawing.Bitmap result = GetBitmap(dib, true);
			Unload(dib);
			return result;
		}
		...
		/// rotating 4-bit images. It's particularly used by <see cref="FreeImageBitmapBase"/>'s
