...
namespace FreeImageAPI
{
	...
	public struct FIRGBAF : IComparable, IComparable<FIRGBAF>, IEquatable<FIRGBAF>, IRGBAColor
	{
		/// <summary>
		...
		{
			get { return this.red; }
			set { this.red = (float)value; }
		}

		double IRGBAColor.G
		{
			get { return this.green; }
			set { this.green = (float)value; }
		}

		double IRGBAColor.B
		{
			get { return this.blue; }
			set { this.blue = (float)value; }
		}

		double IRGBAColor.A
		{
			get { return this.alpha; }
			set { this.alpha = (float)value; }
		}
