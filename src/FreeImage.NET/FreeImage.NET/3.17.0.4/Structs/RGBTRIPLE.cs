...
namespace FreeImageAPI
{
	...
	public struct RGBTRIPLE : IComparable, IComparable<RGBTRIPLE>, IEquatable<RGBTRIPLE>, IRGBAColor
	{
		/// <summary>
		...
		uint R
		{
			get { return (uint)this.rgbtRed; }
			set { this.rgbtRed = (byte)value; }
		}

		uint G
		{
			get { return (uint)this.rgbtGreen; }
			set { this.rgbtGreen = (byte)value; }
		}

		uint B
		{
			get { return (uint)this.rgbtBlue; }
			set { this.rgbtBlue = (byte)value; }
		}
