...
namespace FreeImageAPI
{
	...
	public struct RGBQUAD : IComparable, IComparable<RGBQUAD>, IEquatable<RGBQUAD>,IRGBAColor
	{
		/// <summary>
		...
		uint R
		{
			get { return (uint)this.rgbRed; }
			set { this.rgbRed = (byte)value; }
		}

		uint G
		{
			get { return (uint)this.rgbGreen; }
			set { this.rgbGreen = (byte)value; }
		}

		uint B
		{
			get { return (uint)this.rgbBlue; }
			set { this.rgbBlue = (byte)value; }
		}

		uint A
		{
			get { return (uint)this.rgbReserved; }
			set { this.rgbReserved = (byte)value; }
		}

		double IRGBAColor.R
		{
			get { return this.R / 255d; }
			set { this.R = (uint)Math.Round(value * 255); }
		}

		double IRGBAColor.G
		{
			get { return this.G / 255d; }
			set { this.G = (uint)Math.Round(value * 255); }
		}

		double IRGBAColor.B
		{
			get { return this.B / 255d; }
			set { this.B = (uint)Math.Round(value * 255); }
		}

		double IRGBAColor.A
		{
			get { return this.A / 255d; }
			set { this.A = (uint)Math.Round(value * 255); }
		}
