...
namespace FreeImageAPI
{
	...
	public struct FI16RGB555 : IComparable, IComparable<FI16RGB555>, IEquatable<FI16RGB555>, IRGBAColor
	{
		/// <summary>
		...
		uint R
		{
			get { return ((uint)(this.value & FreeImage.FI16_555_RED_MASK) >> FreeImage.FI16_555_RED_SHIFT); }
			set { this.value = (ushort)(((uint)this.value & (~FreeImage.FI16_555_RED_MASK)) | (value << FreeImage.FI16_555_RED_SHIFT)); }
		}

		uint G
		{
			get { return ((uint)(this.value & FreeImage.FI16_555_GREEN_MASK) >> FreeImage.FI16_555_GREEN_SHIFT); }
			set { this.value = (ushort)(((uint)this.value & (~FreeImage.FI16_555_GREEN_MASK)) | (value << FreeImage.FI16_555_GREEN_SHIFT)); }
		}

		uint B
		{
			get { return ((uint)(this.value & FreeImage.FI16_555_BLUE_MASK) >> FreeImage.FI16_555_BLUE_SHIFT); }
			set { this.value = (ushort)(((uint)this.value & (~FreeImage.FI16_555_BLUE_MASK)) | (value << FreeImage.FI16_555_BLUE_SHIFT)); }
		}
		...
		double IRGBAColor.G
		{
			get { return this.G / 31d; }
			set { this.G = (uint)Math.Round(value * 31); }
		}
