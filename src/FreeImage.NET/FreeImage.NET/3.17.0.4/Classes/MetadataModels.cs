    ...
    public class MDM_EXIF_MAIN : MetadataModel
    {
        ...
        public DateTime? DateTime
        {
            get
            {
				...
				System.DateTime val;
				if (System.DateTime.TryParseExact(text, "yyyy:MM:dd HH:mm:ss\0", DateTimeFormatInfo.InvariantInfo, DateTimeStyles.None, out val))
            ...
            set
            {
                ...
                if (value.HasValue)
                {
					try { val = value.Value.ToString("yyyy:MM:dd HH:mm:ss\0"); }
					catch { }
                }
